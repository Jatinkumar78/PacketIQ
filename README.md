...
![Tests](https://img.shields.io/badge/tests-714%20passing-22c55e?style=for-the-badge&logo=pytest&logoColor=white)
...
**`100%` recall** · **`90%` precision** on real CTU-13 malware · **`15`** detection types · **`7,600+`** live threat-intel indicators · **`714`** tests · **`ruff`-clean**
...
| Trust | unverifiable claims | **714 tests, CI, ruff-clean, fuzz-tested parser** |
...
```bash
pip install -e ".[dev]"
pytest                 # 714 tests: parser, detectors, enrichment, TLS, SIGMA, export, fuzz, AI, security
