...
![Tests](https://img.shields.io/badge/tests-1749%20passing-22c55e?style=for-the-badge&logo=pytest&logoColor=white)
...
**`100%` recall** · **`90%` precision** on real CTU-13 malware · **`15`** detection types · **`7,600+`** live threat-intel indicators · **`1,749`** tests · **`ruff`-clean**
...
| Trust | unverifiable claims | **1,749 tests, 100% line coverage, CI, ruff-clean, fuzz-tested parser** |
...
pytest                                                # run the 1,749-test suite
...
```bash
pip install -e ".[dev]"
pytest                 # 1,749 tests: parser, detectors, enrichment, TLS, SIGMA, export, fuzz, AI, security
