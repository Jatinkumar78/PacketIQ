...
![Tests](https://img.shields.io/badge/tests-251%20passing-22c55e?style=for-the-badge&logo=pytest&logoColor=white)
...
| Trust | unverifiable claims | **251 tests, CI, ruff-clean, fuzz-tested parser** |
...
```bash
pip install -e ".[dev]"
pytest                 # 251 tests: parser, detectors, enrichment, TLS, SIGMA, export, fuzz, AI, security
